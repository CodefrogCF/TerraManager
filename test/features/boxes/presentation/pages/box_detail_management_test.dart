...
void main() {
  ...
  Future<Box> createTestBox({
    ...
    final boxId = await BoxRepository(
      database,
    ).createBox(qrId);
  ...
  testWidgets(
    'shows empty state when no animals are assigned',
    (tester) async {
  ...
  testWidgets(
    'shows animals assigned to the box',
    (tester) async {
      final box = await createTestBox();
  ...
  testWidgets(
    'opens animal detail when assigned animal is tapped',
    (tester) async {
      final box = await createTestBox();
  ...
  testWidgets(
    'shows delete confirmation for empty box',
    (tester) async {
      final box = await createTestBox();
  ...
  testWidgets(
    'does not delete box when deletion is cancelled',
    (tester) async {
      final box = await createTestBox();
  ...
  testWidgets(
    'prevents deleting box with assigned animals',
    (tester) async {
      final box = await createTestBox();
  ...
  testWidgets(
    'deletes empty box and refreshes box overview',
    (tester) async {
      final box = await createTestBox();
