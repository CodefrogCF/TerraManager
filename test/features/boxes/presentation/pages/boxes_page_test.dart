...
void main() {
  ...
  testWidgets(
    'shows empty state when no boxes exist',
    (tester) async {
  ...
  testWidgets(
    'newly created box appears in overview',
    (tester) async {
      await pumpPage(tester);
